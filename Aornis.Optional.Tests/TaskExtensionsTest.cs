...
public class TaskExtensionsTest
{
    ...
    {
        var t = Task.Run<Optional<int>>(() => 123);
    ...
    [Fact]
    public async Task TaskIfPresentExecutesCallback()
    {
        var t = Task.Run<Optional<string>>((() => "hello"));

        bool callbackExecuted = false;
        await t.IfPresentAsync(result =>
        {
